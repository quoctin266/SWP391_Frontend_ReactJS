...
const FAQs = () => {
   return <div className="faqs-container">
      ...
      <Accordion.Item eventKey="0" className="LightGreen">
      ...
      <Accordion.Item eventKey="1" className="LightGreen">
      ...
      <Accordion.Item eventKey="2" className="LightGreen">
      ...
      <Accordion.Item eventKey="3" className="LightGreen" >
    ...
    <Accordion defaultActiveKey="4">
      <Accordion.Item eventKey="4" className="LightGreen">
      ...
      <Accordion.Item eventKey="5" className="LightGreen">
    ...
    <Accordion defaultActiveKey="5">
      <Accordion.Item eventKey="6" className="LightGreen">
      ...
      <Accordion.Item eventKey="7" className="LightGreen">
